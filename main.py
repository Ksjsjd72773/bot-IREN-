...
[C][B][ffffff]- WeLCoMe To BOT HEX BOT 1
          [ffd319]        Good evening
...
[b][i][A5E2CFٍ]telegram: @k_kwb and @DRAGON_HEX7[/b]

[C][B][FF6347] Developer HEX BOT 1  """, uid
                    )
                )
...
Egyptian Developer: HEX BOT 1  
[00FF00]تم تطوير بوت بواسطة @DRAGON_HEX7 and @k_kwb  """, uid
	                    )
	                )
	                time.sleep(0.5)
	                clients.send(
...
[b][c][FFFF00]✨ الى انضمام  [b][c][808000]لدخول الى كلان تواصل  [b][c][FF0000]📩 معي ⏬[b][c][FF00FF]TELEGRAM[ffffff]@k_kwb and @DRAGON_HEX7
[C][B][00FFFF]━━━━━━━━""",uid
	                    )
	                )	            
