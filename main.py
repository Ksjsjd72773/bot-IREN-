        ...
        while True:
            ...
            if senthi == True:
                ...
                clients.send(
                        self.GenResponsMsg(
                            f"""[C][B][1E90FF]╔═══════
[FFFFFF]مرحبا بكم في بوت IREN AND BLACKO DRAGON
[1E90FF]╠
[FFFFFF]هل تريد بوت باسمك خاص تواصل مع مطوري البوت واسعار كسر لا تخاف
[FFFFFF]مطورين البوت: 
[FFD700]تيليجرام: @k_kwb and @BLACK0_DRAGON
[1E90FF]╚══════""", idinv
                        )
                )
                senthi = False
...
[C][B][ffffff]- مرحبا بكم  في بوت  BLACK__BOT
 [ffd319]        صباح الخي
...
[b][c][FF0000]-----------------------------------
[C][B][FFD3EF]-Telegram :@k_kwb and @DRAGON_HEX7
[b][c][FF0000]-----------------------------------""",uid
                            )
                        )
                else:
...
[b][i][A5E2CFٍ]telegram: @k_kwb and @BLACK0_DRAGON[/b]

[C][B][FF6347] Developer BLACK__BOT  """, uid
                    )
                )
    ...
    f"[B][FFA500]• Bio: [FFFFFF]{bio}\n"
	            ...
	            if "1200" in data.hex()[0:4] and b"/blacko" in data:
...
[FFD700]/dev  -> [C][B][00FF00]معلومات مطور البوت

[FF0000]________________________
Egyptian Developer: blacko  
[00FF00]تم تطوير بوت بواسطة @BLACK0_DRAGON and @k_kwb  """, uid
	                    )
	                )
	                time.sleep(0.5)
	                clients.send(
...
[b][c][FFFF00]✨ الى انضمام  [b][c][808000]لدخول الى كلان تواصل  [b][c][FF0000]📩 معي ⏬[b][c][FF00FF]TELEGRAM[ffffff]@k_kwb and @BLACK0_DRAGON
[C][B][00FFFF]━━━━━━━━""",uid
	                    )
	                )	            
