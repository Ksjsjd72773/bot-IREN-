...
[b][i][A5E2CFٍ]telegram: @k_wrj[/b]
 
Enjoy the bot my friend.......

[C][B][FF6347] Developer IREN  """, uid
                    )
                )
    ...
    f"[B][FFA500]• Bio: [FFFFFF]{bio}\n"
	            ...
	            if "1200" in data.hex()[0:4] and b"/iren" in data:
...
Egyptian Developer: IREN 
[00FF00]تم تطوير بوت بواسطة IREN  """, uid
	                    )
	                )
	                time.sleep(0.5)
	                clients.send(
...
[b][c][FFFF00]✨ الى انضمام  [b][c][808000]لدخول الى كلان تواصل  [b][c][FF0000]📩 معي ⏬[b][c][FF00FF]TELEGRAM[ffffff]@k_wrj
[C][B][00FFFF]━━━━━━━━""",uid
	                    )
	                )	            
